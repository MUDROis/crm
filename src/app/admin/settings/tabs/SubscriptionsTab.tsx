        ...
        <tbody>
          ...
          {templates.map(t => (
            <tr key={t.id as string} className="hover:bg-gray-50">
              <td className="border p-2">{t.name as string}</td>
              ...
              <td className="border p-2 space-x-2">
                <button onClick={() => handleEdit(t)} className="text-brand-600 hover:underline text-sm">Ред.</button>
                <button onClick={() => handleTableDelete(t.id as string)} className="text-red-600 hover:underline text-sm">Удалить</button>
              </td>
            </tr>
          ))}
        </tbody>
